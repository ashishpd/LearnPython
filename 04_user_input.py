...
age_string = input("\nEnter your age: ")
print(f"You entered: {age_string}")  # Output: You entered: [user's input]
print(f"Type: {type(age_string)}")  # Output: Type: <class 'str'>

# To use it as a number, we need to convert it
age_int = int(age_string)
print(f"Age as integer: {age_int}")  # Output: Age as integer: [converted number]
print(f"Type: {type(age_int)}")  # Output: Type: <class 'int'>
...
doubled = number * 2
print(f"Double of {number} is {doubled}")  # Output: Double of [number] is [doubled]
...
print(f"Price with tax: ${total:.2f}")  # Output: Price with tax: $[total with 2 decimals]
...
print(f"{first} + {second} = {sum_result}")  # Output: [first] + [second] = [sum]
...
print("\n" + "="*50)  # Output: ==================================================
print("Note: In real programs, you should validate user input")  # Output: Note: In real programs, you should validate user input
print("to ensure they enter the expected type of data.")  # Output: to ensure they enter the expected type of data.
